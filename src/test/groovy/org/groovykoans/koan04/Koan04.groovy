...
class Koan04 extends GroovyTestCase {
    ...
    void test01_IntroToClosures() {
        ...
        def resultClosure
        // ------------ START EDITING HERE ----------------------
        resultClosure = { Integer x, Integer y -> 2 * (x + y) }
        // ------------ STOP EDITING HERE  ----------------------
    ...
    void test02_MoreClosureIntro() {
        ...
        // ------------ START EDITING HERE ----------------------
        filteredResult.write(new File(prefix, 'exercise.txt').filterLine({ it.trim().length() == 0 || it.trim()[0] != '#' }))
        // ------------ STOP EDITING HERE  ----------------------
